...
emitente = Emitente(
    ...
    inscricao_estadual='133758265',  # numero de IE da empresa
...
nota_fiscal = NotaFiscal(
    ...
    totais_tributos_aproximado=Decimal('0.30'),
)
...
nota_fiscal.adicionar_produto_servico(
    ...
    valor_unitario_comercial=Decimal('1.00'),  # preço unitário
    valor_total_bruto=Decimal('1.00'),       # preço total
    unidade_tributavel='UN',
    quantidade_tributavel=Decimal('1'),
    valor_unitario_tributavel=Decimal('1.00'),
    ind_total=1,
    ...
    # aprox. tributos
    valor_tributos_aprox='0.15',
    cbenef=''
)

# Produto 2
nota_fiscal.adicionar_produto_servico(
    codigo='2',                           # id do produto
    descricao='SOJA',
    ncm='12129300',
    # cest='0100100',                            # NT2015/003
    cfop='5101',
